...
control MyIngress(inout headers hdr,
    ...
    action drop() {														                          /*define a acção(funcao) drop()*/
        ...
        action ipv4_forward(macAddr_t dstAddr, egressSpec_t port) {			/*vamos alterar o hdr(copia do header) para depois usadar como novo header do pacote, os arg vem da aplicaçao da tabela*/
