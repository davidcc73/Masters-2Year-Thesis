...
class ExerciseRunner:
    ...
    def create_network(self):
        ...
        self.logger('Adding Controller\n')               #adicionei um controlador
        controller = RemoteController(name='c0', ip='172.17.0.2', protocol='tcp', port=6633)
        c0 = self.net.addController(controller)
        
        self.logger('Starting Controller\n')            #ligar o controlador
        controller.start()
        
        self.logger('Likning Switchs -> Controller\n')   #ligar os switchs ao controlador
