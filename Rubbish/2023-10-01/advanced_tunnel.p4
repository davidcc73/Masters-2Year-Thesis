...
control MyIngress(inout headers hdr,
    ...
    counter(MAX_TUNNEL_ID, CounterType.packets_and_bytes) ingressTunnelCounter;   //varios contadores com diferentes ids, legíveis pelo controller
    ...
    action myTunnel_ingress(bit<16> dst_id) {
        ...
        ingressTunnelCounter.count((bit<32>) hdr.myTunnel.dst_id);  //aumentar o contador nesta var que tem associado a sim um id expecifico
    }
